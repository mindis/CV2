...
\begin{figure}[ht]
	\subfloat[The first dense block of the PVM]{\includegraphics[width=.4\textwidth]{bear_points1}} \quad
	\subfloat[The second dense block of the PVM]{\includegraphics[width=.4\textwidth]{bear_points2}}
