...
Using LO-RANSAC\cite{ransac} in combination with the eight-point algorithm\cite{eightpoint} and the Sampson distance, we can estimate the fundamental matrix.
